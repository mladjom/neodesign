...
[neodesign](../../../../modules.md) / [components/ui/button-enhanced](../README.md) / ButtonProps

# Interface: ButtonProps

Defined in: components/ui/button-enhanced.tsx:45
...
Defined in: components/ui/button-enhanced.tsx:48
...
Defined in: components/ui/button-enhanced.tsx:31
...
Defined in: components/ui/button-enhanced.tsx:51

#### Overrides

`VariantProps.isLoading`
...
Defined in: components/ui/button-enhanced.tsx:49
...
Defined in: components/ui/button-enhanced.tsx:52
...
Defined in: components/ui/button-enhanced.tsx:50
...
> `optional` **size**: `null` \| `"lg"` \| `"sm"` \| `"default"` \| `"icon"` \| `"pill"`

Defined in: components/ui/button-enhanced.tsx:20
...
> `optional` **variant**: `null` \| `"link"` \| `"secondary"` \| `"destructive"` \| `"default"` \| `"outline"` \| `"ghost"` \| `"gradient"`

Defined in: components/ui/button-enhanced.tsx:11
