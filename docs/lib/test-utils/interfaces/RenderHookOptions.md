...
[neodesign](../../../modules.md) / [lib/test-utils](../README.md) / RenderHookOptions

# Interface: ~~RenderHookOptions\<Props, Q, Container, BaseElement\>~~

Defined in: node\_modules/@testing-library/react/types/index.d.ts:241
